# -*- coding: utf-8 -*-
"""
Created on Tue Aug  8 11:59:34 2017

@author: CTTC
"""

"""
https://keras.io/models/sequential/ --> info sobre los parámetros
https://en.wikipedia.org/wiki/Activation_function --> activation functions
https://groups.google.com/forum/#!topic/keras-users/cpXXz_qsCvA --> multiple outs
"""
...
import numpy as np #librería algebre lineal
from gensim.models import KeyedVectors #librería embedding
...
for z in range(5000):
    ...
    ###############################
        ...
        model.fit(data_input, [data_output, data_output2], nb_epoch=300, batch_size=7)
...
aux = dia.round()
aux1 = mes.round()
print (aux) #En la realidad seria el test-set no del trainning
print (aux1)
