...
EMBEDDING_FILE = "/home/sergi/Documents/Machine-Learning/DateParse/SBW-vectors-300-min5.bin.gz"
...
manana =  np.array(word2vec.word_vec('mañana'))
...
#for i in range(31):
    zeros = np.zeros(31, "float32")
    zeros[i]=1
    data_input[i+62] = np.concatenate((manana, zeros), axis=0) 
